            ...
            <SafeAreaView style={{ flex: 1, flexGrow: 1 }}>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
                    <View style={styles.backImgContainer}>
                        <Text style={styles.admin_text}>Admin Dashboard</Text>
                    </View>
                        ...
                        {props.user.full_name != '' &&
                            <View>
                                ...
                                <List.Item
                                    ...
                                    title={'Sellers'}
                                    left={() => <Feather name="users" style={styles.icon} size={20} color={Colors.primary_color} />}
                                ...
                                />
                                <List.Item
                                    onPress={() => props.navigation.navigate('AdminInventory')}
                                    style={styles.list}
                                    titleStyle={{
                                        fontSize: 13, margin: 0, padding: 0, color: 'gray', marginVertical: 0,
                                        marginHorizontal: 0,
                                    ...
                                    title={'Inventry'}
                                    left={() => <AntDesign name={'dashboard'} style={styles.icon} size={25} color={Colors.primary_color} />}
                                    right={() => <AntDesign name={'right'} style={styles.icon} size={15} color={Colors.primary_color} />}
                                />
                                <List.Item
                                ...
                                {orderStackShow && <View style={{ paddingHorizontal: 10, paddingVertical: 5 }}>
                                    <List.Item
                                        onPress={() => { setOrderStackShow(!orderStackShow), props.navigation.navigate('Progress Orders', { from: 'admin', _id: '' }) }}
                                        style={styles.list}
                                        titleStyle={{
                                            fontSize: 13, margin: 0, padding: 0, color: 'gray'
                                        }}
                                    ...
                                    />
                                    <List.Item
                                        onPress={() => { setOrderStackShow(!orderStackShow), props.navigation.navigate('Completed Orders', { from: 'admin', _id: '' }) }}
                                        style={styles.list}
                                        titleStyle={{
                                            fontSize: 13, margin: 0, padding: 0, color: 'gray'
                                        }}
                                ...
                                <List.Item
                                    ...
                                    title={'Slider'}
                                    left={() => <MaterialIcons name="view-carousel" style={styles.icon} size={25} color={Colors.primary_color} />}
                                    right={() => <AntDesign name={'right'} style={styles.icon} size={15} color={Colors.primary_color} />}
                                />
                                <List.Item
                                    ...
                                    title={'Messages'}
                                    left={() => <AntDesign name={'message1'} style={styles.icon} size={25} color={Colors.primary_color} />}
                                    right={() => <AntDesign name={'right'} style={styles.icon} size={15} color={Colors.primary_color} />}
                                />
                            </View>
                        }
