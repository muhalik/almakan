...
export default function CompletedOrders(props) {
    ...
    useEffect(() => {
        ...
        if (from == 'admin') {
            ...
            _url = AlMakanConfig.PATH + `/customer/orders/by/${_id}`
        }
        ...
        axios({
            ...
            let array = []
            res.data.data.docs && res.data.data.docs.forEach(element => {
                ...
                <Card>
                    ...
                    <Card.Actions style={{
                        ...
                        <Button color={'white'} onPress={() => props.navigation.navigate('View Order', { order: item })}
                            uppercase={false} style={{ backgroundColor: Colors.primary_color, color: Colors.primary_text_color }}>
                            View</Button>
                    </Card.Actions>
                </Card>
            </View>
